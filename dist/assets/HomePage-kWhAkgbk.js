...
import{i as e,t}from"./jsx-runtime-D-oznMWL.js";import{t as n}from"./react-DcCgrBX5.js";import{t as r}from"./preload-helper-rov5CBGT.js";import"./api-DLYO2C0C.js";import"./settingsService-DhqqBQqt.js";import{n as i}from"./SettingsContext-BjA5lWzi.js";import{a,o,s}from"./bannerService-CyiVxmKc.js";var c=t(),l=e(n(),1),u=`http://localhost:8000`;function d(e){return`${u}/api/v1/platform/tenants${e}`}function f(e){return`${u}/api/v1/platform${e}`}async function p(e,t={}){let n=await fetch(d(e),{...t,headers:{Accept:`application/json`,...t.body?{"Content-Type":`application/json`}:{},...t.headers||{}}}),r=await n.json().catch(()=>({}));if(!n.ok){let e=Error(r?.message||`No fue posible completar la solicitud.`);throw e.status=n.status,e.data=r,e}return r}function m(e){return p(`/check-subdomain?${new URLSearchParams({subdomain:e}).toString()}`)}function h(e){return p(``,{method:`POST`,body:JSON.stringify(e)})}async function g(){let e=await fetch(f(`/plans`),{headers:{Accept:`application/json`}}),t=await e.json().catch(()=>({}));if(!e.ok){let n=Error(t?.message||`No fue posible cargar los planes.`);throw n.status=e.status,n.data=t,n}return t}function _(){let[e,t]=(0,l.useState)([]),[n,r]=(0,l.useState)(0),[i,a]=(0,l.useState)(!0);(0,l.useEffect)(()=>{let e=!0;async function n(){try{a(!0);let n=y(await o({without_pagination:!0})).filter(e=>(e?.metadata?.section||`home`)===`home`&&!!e?.is_active).sort((e,t)=>Number(e.sort_order??0)-Number(t.sort_order??0)).map(v).filter(e=>e.file);if(!e)return;t(n),r(0)}catch(n){console.error(`Error al cargar banners de inicio:`,n?.response?.data||n),e&&t([])}finally{e&&a(!1)}}return n(),()=>{e=!1}},[]);let s=e[n],u=()=>{r(t=>t===0?e.length-1:t-1)},d=()=>{r(t=>t===e.length-1?0:t+1)};if(i)return(0,c.jsx)(`section`,{className:`hero-banner hero-banner--loading`});if(!s)return null;let f=s.title||s.subtitle,p=f&&s.buttonText&&s.buttonUrl,m=e.length>1;return(0,c.jsx)(`section`,{className:`hero-banner`,children:(0,c.jsxs)(`div`,{className:`hero-banner__media`,children:[s.type===`video`?(0,c.jsx)(`video`,{preload:`none`,className:`hero-banner__video`,src:s.file,autoPlay:!0,muted:!0,loop:!0,playsInline:!0}):(0,c.jsx)(`img`,{loading:`lazy`,className:`hero-banner__image`,src:s.file,alt:s.title||`Banner`}),(0,c.jsx)(`div`,{className:`hero-banner__overlay`,style:{background:`rgba(0,0,0,${s.overlay})`}}),f&&(0,c.jsx)(`div`,{className:`hero-banner__content container-main`,children:(0,c.jsxs)(`div`,{className:`hero-banner__text hero-banner__text--${s.align}`,children:[s.title&&(0,c.jsx)(`h1`,{className:`hero-banner__title`,children:s.title}),s.subtitle&&(0,c.jsx)(`p`,{className:`hero-banner__subtitle`,children:s.subtitle}),p&&(0,c.jsx)(`div`,{className:`hero-banner__actions`,children:(0,c.jsx)(`a`,{href:s.buttonUrl,className:`hero-banner__button`,children:s.buttonText})})]})}),m&&(0,c.jsxs)(c.Fragment,{children:[(0,c.jsx)(`button`,{type:`button`,className:`hero-banner__nav hero-banner__nav--prev`,onClick:u,"aria-label":`Banner anterior`,children:`‹`}),(0,c.jsx)(`button`,{type:`button`,className:`hero-banner__nav hero-banner__nav--next`,onClick:d,"aria-label":`Banner siguiente`,children:`›`}),(0,c.jsx)(`div`,{className:`hero-banner__dots`,children:e.map((e,t)=>(0,c.jsx)(`button`,{type:`button`,className:`hero-banner__dot ${t===n?`is-active`:``}`,onClick:()=>r(t),"aria-label":`Ir al banner ${t+1}`},e.id))})]})]})})}function v(e){return{id:e.id,type:a(e),file:s(e),title:e.title||``,subtitle:e.subtitle||e.description||``,buttonText:e.button_text||``,buttonUrl:e.link_url||``,align:e.metadata?.align||`left`,overlay:Number(e.metadata?.overlay??.34),sortOrder:Number(e.sort_order??0)}}function y(e){let t=e?.data??e;return Array.isArray(t)?t:Array.isArray(t?.data)?t.data:Array.isArray(t?.banners)?t.banners:[]}var b=(0,l.lazy)(()=>r(()=>import(`./BrandBanners-BXWQV-oI.js`),__vite__mapDeps([0,1,2,3,4,5,6,7]))),x=(0,l.lazy)(()=>r(()=>import(`./LatestPurchases-CjfaGpYP.js`),__vite__mapDeps([8,1,9,10,2,11,3,12,13,5,14,15,16,17,18,19]))),S=(0,l.lazy)(()=>r(()=>import(`./MonthlyPromotions-B5AugcIp.js`),__vite__mapDeps([20,1,2,3,21,22]))),C=(0,l.lazy)(()=>r(()=>import(`./OffersSection-B1wDBzVW.js`),__vite__mapDeps([23,1,9,10,2,11,3,12,13,5,14,15,16,17,24,25]))),w={is_published:!1,construction:{title:`Ecommerce en construcción`,message:`Estamos preparando la tienda. Vuelve pronto.`},active_template:`classic`,home_template:`classic`,visual_design:{home:{variant:`classic`}}};function T(){let{settings:e,loading:t,logoUrl:n,brandName:r}=i(),a=e.storefront||w,o=a.active_template||a.home_template||`classic`,s=a.visual_design?.home||{};return t?(0,c.jsx)(`div`,{className:`public-home__loading`,"aria-label":`Cargando inicio`}):a.is_published?(0,c.jsx)(E,{template:o,homeDesign:s}):(0,c.jsx)(ee,{storefront:a,logoUrl:n,brandName:r})}function E({template:e,homeDesign:t}){let n=t?.variant||e||`classic`;return n===`minimal`||e===`minimal`?(0,c.jsxs)(`main`,{className:`public-home public-home--minimal`,children:[(0,c.jsx)(_,{}),(0,c.jsx)(D,{minHeight:320,children:(0,c.jsx)(x,{})}),(0,c.jsx)(D,{minHeight:320,children:(0,c.jsx)(b,{})})]}):n===`showcase`||e===`showcase`?(0,c.jsxs)(`main`,{className:`public-home public-home--showcase`,children:[(0,c.jsx)(_,{}),(0,c.jsx)(D,{minHeight:360,children:(0,c.jsx)(b,{})}),(0,c.jsx)(D,{minHeight:320,children:(0,c.jsx)(x,{source:`favorites`})}),(0,c.jsx)(D,{minHeight:360,children:(0,c.jsx)(S,{})}),(0,c.jsx)(D,{minHeight:320,children:(0,c.jsx)(x,{})})]}):n===`promo_first`||e===`promo`?(0,c.jsxs)(`main`,{className:`public-home public-home--promo`,children:[(0,c.jsx)(D,{minHeight:360,children:(0,c.jsx)(S,{})}),(0,c.jsx)(D,{minHeight:360,children:(0,c.jsx)(C,{})}),(0,c.jsx)(_,{}),(0,c.jsx)(D,{minHeight:320,children:(0,c.jsx)(x,{source:`favorites`})}),(0,c.jsx)(D,{minHeight:320,children:(0,c.jsx)(x,{})}),(0,c.jsx)(D,{minHeight:360,children:(0,c.jsx)(b,{})})]}):(0,c.jsxs)(`main`,{className:`public-home public-home--classic`,children:[(0,c.jsx)(_,{}),(0,c.jsx)(D,{minHeight:360,children:(0,c.jsx)(b,{})}),(0,c.jsx)(D,{minHeight:320,children:(0,c.jsx)(x,{source:`favorites`})}),(0,c.jsx)(D,{minHeight:320,children:(0,c.jsx)(x,{})}),(0,c.jsx)(D,{minHeight:360,children:(0,c.jsx)(S,{})}),(0,c.jsx)(D,{minHeight:360,children:(0,c.jsx)(C,{})})]})}function D({children:e,minHeight:t=320}){let n=(0,l.useRef)(null),[r,i]=(0,l.useState)(!1);return(0,l.useEffect)(()=>{let e=n.current;if(!e||r)return;let t=new IntersectionObserver(([e])=>{e.isIntersecting&&(i(!0),t.disconnect())},{rootMargin:`420px 0px`});return t.observe(e),()=>t.disconnect()},[r]),(0,c.jsx)(`div`,{ref:n,style:r?void 0:{minHeight:t},children:r?(0,c.jsx)(l.Suspense,{fallback:null,children:e}):null})}function ee({storefront:e,logoUrl:t,brandName:n}){let r=e.construction||w.construction;return(0,c.jsx)(`section`,{className:`construction-page`,children:(0,c.jsxs)(`div`,{className:`construction-page__inner`,children:[t?(0,c.jsx)(`img`,{loading:`lazy`,className:`construction-page__logo`,src:t,alt:n||`Logo`}):(0,c.jsx)(`span`,{className:`construction-page__icon`,children:(0,c.jsx)(`i`,{className:`bi bi-shop-window`,"aria-hidden":`true`})}),(0,c.jsx)(`h1`,{children:r.title||w.construction.title}),(0,c.jsx)(`p`,{children:r.message||w.construction.message})]})})}var O=String.raw`<nav class="nav" aria-label="Navegacion principal">
  ...
  </footer>`,k=[{key:`free`,name:`Free`,label:`Gratis por 14 dias`,price:0,currency:`MXN`,interval:null,trial_days:14,description:`Ideal para comenzar a vender sin complicarte.`,features:[`Publica tu tienda y valida tu idea.`,`Configura productos iniciales.`,`Empieza a recibir tus primeros pedidos.`]},{key:`basic`,name:`Basico`,label:`$189.00 /mes`,price:18900,currency:`MXN`,interval:`month`,description:`Lo esencial para vender con catalogo y operacion simple.`,features:[`Catalogo y productos.`,`Clientes y pedidos.`,`Configuracion basica.`,`Plantilla basica incluida.`]},{key:`shop`,name:`Shop`,label:`$429.00 /mes`,price:42900,currency:`MXN`,interval:`month`,description:`Para crecer con canales, marketing y experiencias personalizadas.`,features:[`Todo lo del plan Basico.`,`Canales de venta.`,`Fidelizacion y promociones.`,`Personalizacion y marketing.`],popular:!0},{key:`shop_plus`,name:`Shop+`,label:`$749.00 /mes`,price:74900,currency:`MXN`,interval:`month`,description:`Para equipos que necesitan automatizar, cobrar y conectar mas procesos.`,features:[`Todo lo del plan Shop.`,`Automatizaciones y usuarios.`,`Conexion con envios.`,`Recuperacion de carritos.`,`kuix.app, acceso 6 meses a facturación y cobranza.`,`Aplica al contratar plan anual.`]},{key:`custom`,name:`Ecommerce a la medida`,label:`Conoce mas`,description:`Desarrollo de software y ecommerce personalizado para empresas con procesos especiales.`,features:[`Desarrollo de software a la medida.`,`Integraciones con ERP, CRM, pagos o sistemas internos.`,`Flujos personalizados para tu operacion.`,`Acompanamiento estrategico y tecnico.`],custom:!0}],A=[{label:`Publica tu tienda y valida tu idea.`,minTier:0},{label:`Configura productos iniciales.`,minTier:0},{label:`Empieza a recibir tus primeros pedidos.`,minTier:0},{label:`Catalogo y productos.`,minTier:0},{label:`Clientes y pedidos.`,minTier:0},{label:`Configuracion basica.`,minTier:0},{label:`Plantilla basica incluida.`,minTier:0},{label:`Fidelizacion y promociones.`,minTier:1},{label:`Conexion con envios.`,minTier:1},{label:`Personalizacion y marketing.`,minTier:2},{label:`Automatizacion y usuarios.`,minTier:2},{label:`Cupones.`,minTier:2},{label:`Fidelizacion.`,minTier:2},{label:`Carritos abandonados.`,minTier:2},{label:`Conecta tu dominio.`,minTier:3}];function j({createStorePath:e=`/registro`,loginPath:t=`/login`}){let n=(0,l.useRef)(null),[r,i]=(0,l.useState)(k),a=(0,l.useMemo)(()=>K(r,e,`monthly`),[e,r]),o=(0,l.useMemo)(()=>U(P(N(O,a)).replaceAll(`href="/registro"`,`href="${e}"`).replaceAll(`href="/login"`,`href="${t}"`).replaceAll(`href="#planes"`,`href="/precios"`)),[e,t,a]);return(0,l.useEffect)(()=>{let e=n.current,t=e?.querySelector(`.nav`),i=!1,a=()=>{t&&(t.classList.toggle(`is-scrolled`,window.scrollY>18),i=!1)};a();let o=()=>{i||=(window.requestAnimationFrame(a),!0)};window.addEventListener(`scroll`,o,{passive:!0});let s=[`vender mas`,`conectar con tus clientes`,`todo lo que imagines`],c=e?.querySelector(`#heroWord`),l=0,u=window.setInterval(()=>{c&&(l=(l+1)%s.length,c.animate([{opacity:1,transform:`translateY(0)`},{opacity:0,transform:`translateY(-14px)`}],{duration:260,easing:`cubic-bezier(.22, 1, .36, 1)`}).onfinish=()=>{c.textContent=s[l],c.animate([{opacity:0,transform:`translateY(14px)`},{opacity:1,transform:`translateY(0)`}],{duration:420,easing:`cubic-bezier(.22, 1, .36, 1)`})})},2400),d=new IntersectionObserver(e=>{for(let t of e)t.isIntersecting&&(t.target.classList.add(`visible`),d.unobserve(t.target))},{threshold:.14});e?.querySelectorAll(`.reveal`).forEach(e=>d.observe(e));let f=e=>{if(e.tagName===`IMG`){let t=e.dataset.src;if(!t)return;e.onerror=()=>{e.dataset.fallbackSrc&&e.src!==e.dataset.fallbackSrc&&(e.src=e.dataset.fallbackSrc)},e.src=t,e.removeAttribute(`data-src`);return}e.querySelectorAll(`source[data-src]`).forEach(e=>{e.src=e.dataset.src,e.removeAttribute(`data-src`)}),e.load(),e.autoplay&&e.play().catch(()=>{})},p=new IntersectionObserver(e=>{for(let t of e){let e=t.target;if(t.isIntersecting){f(e),e.tagName===`VIDEO`&&e.autoplay&&e.play().catch(()=>{});continue}e.tagName===`VIDEO`&&e.pause()}},{rootMargin:`520px 0px`,threshold:.08});e?.querySelectorAll(`img[data-src], video[data-lazy-media]`).forEach(e=>{p.observe(e)});let m=e?.querySelectorAll(`[data-plan-period]`),h=t=>{let n=t.currentTarget?.dataset?.planPeriod;(n===`monthly`||n===`annual`)&&(m?.forEach(e=>{e.classList.toggle(`is-active`,e.dataset.planPeriod===n)}),Q(e,r,n))};return m?.forEach(e=>{e.addEventListener(`click`,h)}),()=>{window.removeEventListener(`scroll`,o),window.clearInterval(u),d.disconnect(),p.disconnect(),m?.forEach(e=>{e.removeEventListener(`click`,h)})}},[o,r]),(0,l.useEffect)(()=>{let e=!0;return g().then(t=>{if(!e)return;let n=W(t);n.length&&i(n)}).catch(e=>{console.error(`Error cargando planes públicos:`,e?.data||e)}),()=>{e=!1}},[]),(0,c.jsx)(`div`,{ref:n,className:`cloudishop-home`,dangerouslySetInnerHTML:{__html:o}})}function M({createStorePath:e=`/registro`,loginPath:t=`/login`}){let n=(0,l.useRef)(null),[r,i]=(0,l.useState)(k),a=(0,l.useMemo)(()=>F(K(r,e,`monthly`),L(r,e),e,t),[e,t,r]);return(0,l.useEffect)(()=>{let e=n.current,t=e?.querySelector(`.nav`),i=e?.querySelector(`.pricing-comparison-wrap`),a=e?.querySelector(`.pricing-faq-wrap`),o=!1,s=()=>{if(!t)return;let n=i?i.offsetTop-120:1/0,r=a?a.offsetTop-120:i?i.offsetTop+i.offsetHeight-180:-1/0,s=window.scrollY>=n&&window.scrollY<r;t.classList.toggle(`is-scrolled`,window.scrollY>18),t.classList.toggle(`is-hidden-on-comparison`,s),e?.classList.toggle(`is-comparing`,s),o=!1};s();let c=()=>{o||=(window.requestAnimationFrame(s),!0)};window.addEventListener(`scroll`,c,{passive:!0});let l=new IntersectionObserver(e=>{for(let t of e)t.isIntersecting&&(t.target.classList.add(`visible`),l.unobserve(t.target))},{threshold:.14});e?.querySelectorAll(`.reveal`).forEach(e=>l.observe(e));let u=e?.querySelectorAll(`[data-plan-period]`),d=t=>{let n=t.currentTarget?.dataset?.planPeriod;(n===`monthly`||n===`annual`)&&(u?.forEach(e=>{e.classList.toggle(`is-active`,e.dataset.planPeriod===n)}),Q(e,r,n))};return u?.forEach(e=>{e.addEventListener(`click`,d)}),()=>{window.removeEventListener(`scroll`,c),l.disconnect(),u?.forEach(e=>{e.removeEventListener(`click`,d)})}},[a,r]),(0,l.useEffect)(()=>{let e=!0;return g().then(t=>{if(!e)return;let n=W(t);n.length&&i(n)}).catch(e=>{console.error(`Error cargando planes públicos:`,e?.data||e)}),()=>{e=!1}},[]),(0,c.jsx)(`div`,{ref:n,className:`cloudishop-home cloudishop-pricing`,dangerouslySetInnerHTML:{__html:a}})}function N(e,t){return e.replace(/<div class="plans-billing-toggle"[\s\S]*?<\/div>\s*(?=<div class="plans-grid">)/,I(`monthly`)).replace(/<div class="plans-grid">[\s\S]*?<article class="plan-card dark reveal">[\s\S]*?<\/article>\s*<\/div>/,`<div class="plans-grid">${t}</div>`)}function P(e){return e.replace(/\s*<section class="plans-section" id="planes">[\s\S]*?<\/section>\s*(?=<section class="final-cta")/,`

    `)}function F(e,t,n,r){return String.raw`<nav class="nav is-scrolled" aria-label="Navegacion principal">
    <div class="shell">
      ...
      <div class="nav-actions">
        <a class="login-link" href="${$(r)}">Ingresar</a>
        <a class="btn btn-primary" href="${$(n)}">Crear CloudiShop gratis</a>
      </div>
    </div>
  </nav>
  ...
  <main>
    <section class="plans-section pricing-hero" id="planes">
      <div class="shell">
        ...
        <div class="plans-grid pricing-grid">${e}</div>
      </div>
    </section>
  ...
  <footer>
    ...
    <div class="footer-bottom">
      <div class="shell">
  ...
  </footer>`}function I(e=`monthly`){return`
        <div class="plans-billing-toggle" role="group" aria-label="Periodo de pago">
        ...
        </div>`}function L(e,t){let n=B(e);return`
          ...
          <div class="pricing-comparison-scroll">
            <div class="pricing-comparison-grid">
              <div class="pricing-comparison-head">
                ...
                ${n.map(e=>{let n=Number(e.price||0)===0&&!e.custom?`Crea gratis`:`Comienza gratis`;return`
          <div class="compare-plan">
            <strong>${$(e.name)}</strong>
            <span class="compare-plan-price">${$(J(e,`monthly`))}</span>
            <a class="btn compare-plan-btn" href="${$(t)}">${n}</a>
          </div>`}).join(``)}
              </div>
              <div class="comparison-section-title">Precios</div>
              ${H(`Pago mensual`,n.map(e=>J(e,`monthly`)))}
              ${H(`Pago anual`,n.map(e=>J(e,`annual`)))}
              <div class="comparison-section-title">Funciones principales</div>
              ${A.map(e=>{let t=n.map((t,n)=>V(t,n)>=e.minTier?`<span class="compare-check" aria-label="Incluido">&#10003;</span>`:`<span class="compare-dash">-</span>`);return H(e.label,t,!0)}).join(``)}
            </div>
          </div>
        </div>
      ...
      <div class="pricing-faq-panel">
        <div class="shell pricing-faq-grid">
          ...
          <div class="pricing-faq-list reveal">
            ${[{question:`¿Qué es CloudiShop y cómo funciona?`,answer:`CloudiShop es una plataforma ecommerce para crear tu tienda online, configurar productos, recibir pedidos, administrar clientes, activar promociones y operar tus ventas desde un solo lugar. No necesitas programar para empezar.`},{question:`¿Cuánto cuesta CloudiShop?`,answer:`Puedes comenzar con una prueba gratis de 14 dias. Despues puedes elegir el plan que mejor se ajuste a tu etapa: Free, Basico, Shop o Shop+.`},{question:`¿Puedo cancelar o cambiar mi plan en cualquier momento?`,answer:`Si. Puedes cambiar de plan cuando tu negocio necesite mas funciones o ajustar tu suscripcion desde tu cuenta.`},{question:`¿Hay cargos adicionales?`,answer:`CloudiShop no cobra cargos de configuracion para crear tu tienda. Pueden existir comisiones o costos de terceros segun el proveedor de pago, envio o integracion que uses.`},{question:`¿Puedo usar mi propio dominio con CloudiShop?`,answer:`Si. En el plan Shop+ puedes conectar tu dominio para que tu tienda opere con la identidad de tu marca.`},{question:`¿CloudiShop incluye alojamiento web?`,answer:`Si. Tu tienda se publica en la infraestructura de CloudiShop, por lo que no necesitas contratar alojamiento por separado para comenzar a vender.`}].map((e,t)=>`
          <details class="pricing-faq-item"${t===0?` open`:``}>
          ...
          </aside>`}function B(e=[]){let t=e.length?e:k,n=t.filter(e=>{let t=String(e.key||``).toLowerCase(),n=String(e.name||``).toLowerCase();return!e.custom&&!t.includes(`custom`)&&!n.includes(`medida`)}),r=k.filter(e=>!e.custom),i=[...n];return r.forEach(e=>{i.some(t=>String(t.key||t.name)===String(e.key||e.name))||i.push(e)}),(i.length?i:t).slice(0,4)}function V(e={},t=0){let n=String(e.key||``).toLowerCase(),r=String(e.name||``).toLowerCase();return n.includes(`free`)||r.includes(`free`)||r.includes(`gratis`)?0:n.includes(`basic`)||n.includes(`basico`)||r.includes(`basic`)||r.includes(`basico`)?1:n.includes(`shop_plus`)||n.includes(`plus`)||r.includes(`shop+`)?3:n.includes(`shop`)||r.includes(`shop`)?2:Math.min(t,3)}function H(e,t,n=!1){let r=t.map(e=>`<div>${n?e:$(e)}</div>`).join(``);return`
              <div class="comparison-row">
                <div>${$(e)}</div>
                ${r}
              </div>`}function U(e){return e.replace(/<img(?![^>]*\bloading=)([^>]*)>/g,`<img loading="lazy" decoding="async"$1>`).replace(/<video(?![^>]*\bpreload=)([^>]*)>/g,`<video preload="none"$1>`).replace(/<video preload="none"([^>]*class="hero-video"[^>]*)>/g,`<video preload="metadata"$1>`).replace(/src="(\/imgs_tiendas\/[^"]+\.webp)"/g,`data-src="$1"`).replace(/src="(\/imgs_home\/pedidoslistos\.webp)"/g,`data-src="$1"`).replace(/src="(\/dashboard-demo\.webp)"/g,`data-src="$1"`).replace(/src="(https:\/\/images\.pexels\.com\/photos\/[^"]+)"/g,`data-src="$1"`).replace(/<video preload="none"(?![^>]*class="hero-video")([^>]*)>\s*<source src="(?!https:\/\/videos\.pexels\.com\/video-files\/7855449)([^"]+)"/g,`<video preload="none" data-lazy-media$1><source data-src="$2"`).replace(/<video preload="none" data-lazy-media([^>]*)preload="none"/g,`<video preload="none" data-lazy-media$1preload="none"`)}function W(e){return G((Array.isArray(e?.data)?e.data:Array.isArray(e?.data?.plans)?e.data.plans:Array.isArray(e?.plans)?e.plans:[]).map(e=>({key:e.key||e.plan_key||e.name,name:e.name||e.label||`Plan`,label:J(e),price:e.price,currency:e.currency,interval:e.interval,default_billing_period:e.default_billing_period||`monthly`,billing_options:X(e),trial_days:e.trial_days??e.trialDays??e.free_days??e.freeDays??null,badge:e.badge||e.badge_label||e.badgeLabel||``,description:e.description||``,features:Array.isArray(e.features)?e.features:[],popular:!!(e.popular||e.is_popular||String(e.key).toLowerCase()===`shop`),custom:!!(e.custom||e.is_custom)})))}function G(e=[]){if(e.some(e=>{let t=String(e.key||``).toLowerCase(),n=String(e.name||``).toLowerCase();return e.custom||t.includes(`custom`)||t.includes(`medida`)||n.includes(`medida`)}))return e;let t=k.find(e=>e.custom);return t?[...e,t]:e}function K(e,t,n=`monthly`){return(e.length?e:k).map(e=>{let r=Number(e.price||0)===0&&!e.custom,i=e.custom||String(e.key||``).toLowerCase().includes(`custom`),a=i?`plan-card dark reveal`:`plan-card reveal`,o=i?`Conoce mas`:r?`Crea gratis`:`Contratar`,s=i?`https://wa.me/523332244005`:t,c=i?` target="_blank" rel="noopener noreferrer"`:``,l=q(e),u=e.popular?`<span class="plan-badge">${$(l)}</span><span class="plan-badge alt">Popular</span>`:`<span class="plan-badge">${$(l)}</span>`,d=Z(e,n),f=n===`annual`&&d?.savings_label||``,p=(Array.isArray(e.features)&&e.features.length?e.features:[`Incluye herramientas para operar tu tienda.`]).map(e=>`<li>${$(e)}</li>`).join(``);return`
          <article class="${a}" data-plan-key="${$(e.key||e.name)}">
            <div class="plan-badges">${u}</div>
            <div class="plan-name">${$(e.name)}</div>
            <div class="plan-price">${$(J(e,n))}</div>
            <div class="plan-savings${f?``:` is-empty`}">${$(f)}</div>
            <p class="plan-desc">${$(e.description||``)}</p>
            <ul class="plan-features">${p}</ul>
            <div class="plan-action"><a class="btn" href="${$(s)}"${c}>${o}</a></div>
          </article>`}).join(``)}function q(e={}){if(e.badge)return e.badge;let t=Number(e.price||0)===0&&!e.custom,n=Number(e.trial_days??e.trialDays??e.free_days??e.freeDays??0);return t&&n>0?`Free ${n} dias`:t?`Free 14 dias`:e.name||`Plan`}function J(e={},t=`monthly`){let n=Z(e,t),r=Number(n?.price??e.price??0),i=!!(e.custom||e.is_custom),a=r===0&&!i,o=Number(e.trial_days??e.trialDays??e.free_days??e.freeDays??0),s=n?.label||e.label||e.display_label||e.price_label||e.priceLabel||``;return a&&o>0?`Gratis por ${o} dias`:s||(a?`Gratis por 14 dias`:Y(e,t))}function Y(e={},t=`monthly`){let n=Z(e,t),r=Number(n?.price??e.price??0);if(!r)return`Gratis`;let i=r>=1e3?r/100:r,a=String(n?.currency||e.currency||`MXN`).toUpperCase(),o=n?.interval||e.interval,s=o===`year`?` /año`:o===`month`?` /mes`:``;return`${new Intl.NumberFormat(`es-MX`,{style:`currency`,currency:a,minimumFractionDigits:2}).format(i)}${s}`}function X(e={}){return Array.isArray(e.billing_options)?e.billing_options.map(t=>({key:t.key||`monthly`,label:t.label||``,price:t.price,amount:t.amount,currency:t.currency||e.currency||`MXN`,interval:t.interval||(t.key===`annual`?`year`:`month`),months_charged:Number(t.months_charged??0),months_free:Number(t.months_free??0),savings_label:t.savings_label||``})):[]}function te(e={}){let t=Array.isArray(e.billing_options)?e.billing_options:[];return t.length?t.find(t=>t.key===e.default_billing_period)||t.find(e=>e.key===`monthly`)||t[0]:null}function Z(e={},t=`monthly`){let n=(Array.isArray(e.billing_options)?e.billing_options:[]).find(e=>e.key===t);if(n)return n;if(t===`annual`&&Number(e.price||0)>0&&!e.custom){let t=Number(e.price||0);return{key:`annual`,label:Y({...e,price:t*10,interval:`year`,billing_options:[]}),price:t*10,currency:e.currency||`MXN`,interval:`year`,months_charged:10,months_free:2,savings_label:`2 meses gratis`}}return te(e)}function Q(e,t=[],n=`monthly`){(t.length?t:k).forEach(t=>{let r=String(t.key||t.name||``),i=e?.querySelector(`[data-plan-key="${ne(r)}"]`);if(!i)return;let a=i.querySelector(`.plan-price`),o=i.querySelector(`.plan-savings`),s=Z(t,n),c=n===`annual`&&s?.savings_label||``;a&&(a.textContent=J(t,n),a.classList.remove(`is-updating`),a.offsetWidth,a.classList.add(`is-updating`)),o&&(o.textContent=c,o.classList.toggle(`is-empty`,!c),o.classList.remove(`is-updating`),o.offsetWidth,o.classList.add(`is-updating`))})}function ne(e=``){return typeof CSS<`u`&&typeof CSS.escape==`function`?CSS.escape(e):String(e).replaceAll(`"`,`\\"`).replaceAll(`\\`,`\\\\`)}function $(e=``){return String(e).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#039;`)}export{j as CloudiShopMarketingHome,M as CloudiShopPricingPage,T as default,h as n,m as t};