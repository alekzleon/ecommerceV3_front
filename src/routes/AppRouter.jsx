...
const ADMIN_ROUTE_NAME_PATHS = {
  ...
  "admin.stripe-connect.index": "/admin/payments",
  "admin.custom-domains.index": "/admin/domains",
  "admin.custom_domains.index": "/admin/domains",
...
const ADMIN_MODULE_NAME_PATHS = {
  ...
  stripe_connect: "/admin/payments",
  stripe: "/admin/payments",
  dominios_personalizados: "/admin/domains",
  custom_domains: "/admin/domains",
